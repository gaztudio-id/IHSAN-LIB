...
<div class="bg-white rounded-xl shadow-sm p-6 max-w-2xl">
    <div class="mb-6">
        <h3 class="text-lg font-semibold text-gray-800">Form Tambah Pengguna</h3>
    </div>
    ...
    <form action="{{ route('admin.users.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="rfid_code" type="text" name="rfid_code" placeholder="Scan kartu atau ketik kode">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-6">
            ...
            <select class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="role" name="role">
                <option value="staff_perpus">Staff Perpustakaan</option>
